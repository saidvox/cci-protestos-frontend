...
import { adaptAnalyst, adaptAudit, adaptDashboard, adaptEntity, adaptLogin, adaptPage, adaptProtest, adaptReport, adaptRequest, type AnalystDto, type AuditDto, type DashboardDto, type EntityDto, type LoginDto, type PageDto, type ProtestDto, type ReportDto, type RequestDto } from "@/shared/services/api-adapters"
