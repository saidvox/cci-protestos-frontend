import type { Analyst, AuditEntry, AuthSession, CreateRequestInput, DashboardSummary, FinancialEntity, LoginCredentials, Page, PageQuery, Protest, ProtestFilters, RegisterInput, RequestQuery, RequestRecord, RequestReport, RequestStatus } from "@/shared/types/domain"
